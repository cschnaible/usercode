...
MODELS = ['ZprimeQToMuMu_M9000','DYToMuMu']
RESMASSES = ['9000']
...
f = '../submit/crab{EXTRA}/crab_{MODEL}_M-{LOW}To{HIGH}_{PDF}_*_20190227/results/cmsRun-stdout-1.log'
...
for PDF in PDFS:
    for MODEL in MODELS:
        ...
        for LOW,HIGH in zip(MASSBINSLOW,MASSBINSHIGH):
            ...
            print glob.glob(f.format(**locals()))
